...
public final class MarkupListTest {
    public static final ModelessSelector<?> SELECTOR = VariantTester.selector(MarkupListTest.class, MarkupTester.test(MarkupListTest::test))
            .variant("HtmlList", MarkupTester.variant("Html", Map.of()))
            .variant("BBCodeList", MarkupTester.variant("BBCode", Map.ofEntries(
                    Map.entry("<em>", "[i]"),
                    Map.entry("</em>", "[/i]"),
                    Map.entry("<strong>", "[b]"),
                    Map.entry("</strong>", "[/b]"),
            ...
            .variant("TexList", MarkupTester.variant("Tex", Map.ofEntries(
                    Map.entry("<em>", "\\emph{"),
                    Map.entry("</em>", "}"),
