...
public class TalkRepositoryImpl implements TalkRepository {
    ...
    public void save(Talk talk) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement("INSERT INTO `Talks` (`sourceUserId`, `targetUserId`, `text`, `creationTime`) VALUES (?, ?, ?, NOW())", Statement.RETURN_GENERATED_KEYS)) {
                ...
                if (statement.executeUpdate() != 1) {
                    ...
                    if (generatedKeys.next()) {
                        ...
                        throw new RepositoryException("Can't save Id [no autogenerated fields].");
                    }
                }
            }
        } catch (SQLException e) {
            throw new RepositoryException("Could not save talk " + talk.getId(), e);
        }
    }
