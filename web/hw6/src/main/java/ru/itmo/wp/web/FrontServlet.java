...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method = getMethod(route.getAction(), pageClass);
        Method before = getMethod("before", pageClass);
        Method after = getMethod("after", pageClass);
        if (method == null) {
            throw new NotFoundException();
        }
    ...
    private Method getMethod(String action, Class<?> pageClass) {
        Method method = null;
