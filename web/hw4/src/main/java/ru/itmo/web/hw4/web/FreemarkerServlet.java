...
public class FreemarkerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            template = freemarkerConfiguration.getTemplate("not-found.ftlh");
        }
    ...
    private Map<String, Object> getData(HttpServletRequest request) {
        ...
        try {
            Long logged_user_id = Long.valueOf(request.getParameter("logged_user_id"));
            request.getSession().setAttribute("logged_user_id", logged_user_id);
        } catch (NumberFormatException ignored) {

        }
        Long logged_used_id = (Long) request.getSession().getAttribute("logged_user_id");
        if (logged_used_id != null) {
            data.put("logged_user_id", logged_used_id);
        }
