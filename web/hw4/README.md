...
Cкачайте учебный проект по ссылке [https://assets.codeforces.com/files/69565a5324cd/hw4.zip](https://assets.codeforces.com/files/69565a5324cd/hw4.zip)
...
![user page](readme_img/user_page.png)

Картинку стоит отображать всем одинаковую (можно взять с [https://userpic.codeforces.com/no-title.jpg](https://userpic.codeforces.com/no-title.jpg)). Стрелки должны функционировать и переводить на предыдущего по списку или следующего пользователя (если есть). Если такого нет - то стрелка должна стать серой и перестать быть ссылкой (как на скриншоте выше).
...
![underline](readme_img/underline.png)
...
![404 page](readme_img/404page.png)
