...
public class CalculatorTreeClasses {
    ...
    static {
        ...
        NAME_TO_CTOR.put(CalculatorToken.MULTIPLY, MULTIPLY::new);
        NAME_TO_CTOR.put(CalculatorToken.DIVIDE, DIVIDE::new);
        NAME_TO_CTOR.put(CalculatorToken.FUNC, FUNC::new);
