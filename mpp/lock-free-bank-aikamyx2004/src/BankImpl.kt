...
//            val newAccount = Account(account.amount)
//            newAccount
//            accounts[index].
...
//                        val fromAcc = Account(from.amount-amount);
//                        val toAcc = Account(to.amount+amount);
//
//                        accounts[fromIndex].value = fromAcc;
//                        accounts[toIndex].value = toAcc;
